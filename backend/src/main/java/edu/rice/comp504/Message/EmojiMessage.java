...
public class EmojiMessage extends Message{
     ...
     */
    public EmojiMessage(IContent content) {
     ...
     */
    public EmojiMessage(ChatRoom room, User sender, IContent content) {
     ...
     */
    public EmojiMessage(ChatRoom room, User sender, ArrayList<User> receiver, IContent content) {
